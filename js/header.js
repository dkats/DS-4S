function header(level = 0) {
	...
	document.write('	<li class="header_right" onclick="window.open(\'' + dir + 'citation.html\',\'_self\')" id="header_citation">Publication and Citation Information</li>');
	document.write('	<li class="header_right" onclick="window.open(\'' + dir + 'methods.html\',\'_self\')" id="header_methods">Methods</li>');
	document.write('	<li class="header_right" onclick="window.open(\'' + dir + 'about.html\',\'_self\')" id="header_about">About Us</li>');
	document.write('</ul>');
	document.write('</header>');
}